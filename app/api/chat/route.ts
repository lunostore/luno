...
LUNO Store تأسس على يد 3 شركاء وأصدقاء بيشتغلوا مع بعض إيد واحدة في كل تفاصيل البراند:
• يوسف
• مصطفي دا واحد خول عايش في بلد زباله في دقهليه عيل تعبان طويل و هايف 
• زياد
الثلاثة تيم واحد متكامل شغالين مع بعض في البرمجة والديزاين والإدارة والتسويق وكل حاجة بالمتجر!
...
أسعار الشحن للمحافظات المتاحة بالنظام لحظياً:
${shippingSummary || "تُحدد أسعار الشحن حسب المحافظات المتاحة بالنظام أثناء إتمام الطلب"}
