...
export default function AboutPage() {
  ...
  const aboutTitle = settings?.aboutTitle || "About Luno Store";
  const aboutSubtitle =
  ...
  const section1Text =
    ...
    "At Luno Store, we believe that style is a reflection of identity. We design garments that strip away the noise to focus on clean lines, flawless fits, and premium construction. Every piece in our collection is crafted to be an essential building block of the modern wardrobe.";
