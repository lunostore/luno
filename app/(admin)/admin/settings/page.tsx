...
export default function AdminSettingsPage() {
  ...
  const [settings, setSettings] = useState<SiteSettings>({
    ...
    aboutSection1Text: "At Luno Store, we believe that style is a reflection of identity. We design garments that strip away the noise to focus on clean lines, flawless fits, and premium construction. Every piece in our collection is crafted to be an essential building block of the modern wardrobe.",
    aboutSection1Image: "",
...
Contact Us
If you have questions about this Privacy Policy, please contact us at official support channels.`,
    termsOfServiceText: `Acceptance of Terms
By using Luno Store, you agree to these Terms of Service. If you do not agree, please do not use our website or services.
