...
export default function AdminShippingPage() {
  ...
  return (
    <div className="space-y-8 font-sans" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-zinc-200/80 shadow-sm">
        <div>
          <h1 className="text-xl font-black text-zinc-900 tracking-tight flex items-center gap-2">
            ...
            إدارة أسعار الشحن للمحافظات المصرية (27 محافظة)
          </h1>
          <p className="text-xs text-zinc-500 mt-1">
            تخصيص أسعار وتكلفة الشحن لجميع المحافظات. تطبق التغييرات فوراً أثناء إتمام الشراء للعميل.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-r from-zinc-900 via-zinc-850 to-zinc-900 text-white p-6 rounded-2xl border border-zinc-800 shadow-md space-y-4">
      ...
      {loading ? (
        <div className="bg-white rounded-2xl border border-zinc-200/80 p-16 flex items-center justify-center">
          <div className="text-center space-y-3">
            <Spinner size="lg" />
            <p className="text-xs text-zinc-400 font-bold uppercase tracking-wider">جارٍ تحميل أسعار المحافظات...</p>
          </div>
        </div>
      ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-zinc-50/80 border-b border-zinc-100 text-[10px] font-extrabold text-zinc-400 uppercase tracking-wider">
                  <th className="px-6 py-4 text-right">المحافظة بالعربية</th>
                  <th className="px-6 py-4 text-right">الاسم بالإنجليزية</th>
                  <th className="px-6 py-4 text-right">الشحن الأساسي (أول 1 كجم)</th>
                  <th className="px-6 py-4 text-right">الكيلو الإضافي (+1 كجم)</th>
                  <th className="px-6 py-4 text-center">حالة التفعيل</th>
                </tr>
              </thead>
